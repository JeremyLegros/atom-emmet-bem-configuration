...
### I.1) Setup the preferences
  Place the atom-emmet-bem-configuration folder (rename it as you wish) somewhere meaningful, <br/>something like  "&#126;/.atom/" or "&#126;/.atom/packages/emmet/" etc..<br/>
